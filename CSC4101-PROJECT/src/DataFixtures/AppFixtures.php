...
class AppFixtures extends Fixture
{
    ...
    public function loadTerritories(ObjectManager $manager)
    {
        // $territoriesRepo = $manager->getRepository(Territories::class);
    ...
    public function load(ObjectManager $manager)
    {
        ...
        foreach (self::exoplanetDataGenerator() as [$territoriesReference, $description])
        {
            ...
            // Require that the ORM\OneToMany attribute on Territories::exoplanet has "cascade: ['persist']"
            $manager->persist($territories);
            dump($territories);
            dump($exoplanet);
        }
